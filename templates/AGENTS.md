...
8. Confirm repository, working branch, production branch, environment, Supabase project and Netlify deploy target.
9. Propose the Activation Set and ask whether additional project-specific agreements/assets should be activated.
10. If required context cannot be retrieved or conflicts, stop and inform the user. Do not guess.
